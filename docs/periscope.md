...
The [API documentation](The [API documentation](https://app.swaggerhub.com/api/Cloudbreak/Periscope/1.6.2) was generated from the code using [Swagger](http://swagger.io/).
